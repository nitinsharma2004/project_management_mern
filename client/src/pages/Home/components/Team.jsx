...
import photo from "../../../Images/HeroImage.jpg";
...
const Team = () => {
  const member = [{
    ...
    bio: "I have expertise in full-stack web development, app development, and MERN stack development. I am knowledgeable in various programming languages, frameworks, and technologies and strive to create high-quality, user-friendly applications."
  },
