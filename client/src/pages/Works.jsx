...
const ProjectDetails = () => {
  ...
  const handleUpdate = async (workId,taskId, newStatus) => {
    console.log(workId);
    console.log(taskId);
    const dataToUpdate = {
      workId: workId,
                      ...
                      {works
                        ...
                        .map((item) => (
                          <div onClick={() => openWorkDetails(item)}>
                            <WorkCards status="In Progress" work={item} handleUpdate={handleUpdate} from = "works" />
                          </div>
                        ))}
                    </Masonry>
                  </ResponsiveMasonry>
                  ...
                  <ResponsiveMasonry columnsCountBreakPoints={{ 350: 1, 750: 2, 900: 2 }}>
                    <Masonry gutter="14px">
                      {works
                        ...
                        .map((item) => (
                          <div onClick={() => openWorkDetails(item)}>
                            <WorkCards status="Completed" work={item} handleUpdate={handleUpdate} from = "works"/>
                          </div>
                        ))}
                    </Masonry>
                  </ResponsiveMasonry>
